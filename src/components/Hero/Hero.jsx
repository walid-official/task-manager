      ...
      <div className="lg:flex justify-center items-center">
        <div className="py-20">
          ...
          <div className="flex justify-center">
            <button onClick={handleGoogleSignin}  className="bg-gradient-to-r from-[#007bff] to-[#007bff] px-8 py-3 rounded-full cursor-pointer text-white text-xl font-medium flex gap-2 items-center group transition-all duration-300">
